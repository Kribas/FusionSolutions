...
import 'package:fusionsolutions/pages/MovieDetails/BsrMoviesDetail.dart';
                      ...
                      return Stack(
                        children: [
                          ...
                          Material(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.push(context,PageTransition(child: BsrMoviesDetails(bsrMovies: movie), type: PageTransitionType.leftToRight));
